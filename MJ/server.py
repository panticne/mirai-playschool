""" This file is the server of the game Mirai-playschool, you can monitor game here, connect via a reverse shell
to client, see historic of last games, setup the game parameters"""
    ...
    def check_game_is_ok(self):
        ...
        with self.lock:
            ...
            if len(self.all_rasp) < self.minimal_card:
                ...
                return False
            if len(self.all_player) == 0 or len(self.all_rasp) == 0:
