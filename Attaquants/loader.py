...
def infect_force(ip_server, passwords_file):
    # Source https://github.com/add1ct3d/B0n3tBrute/blob/master/TelnetBrute.py
    """
    ...
    for x in range(len(all_creds)):
        ...
        try:
            ...
            while True:
                ...
                # We check only ogin because it could print Login and login, same for other words
                ...
                if "pi@" in response.decode("utf-8") and chmod_done:
                    ...
                    time.sleep(10)
                # We check if all actions has been done and we leave
